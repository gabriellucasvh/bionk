...
export default function DefaultTemplate({ user }: TemplateComponentProps) {
  return (
    <div className="min-h-screen bg-neutral-950 py-8 px-4 text-white flex flex-col">
      ...
      <footer className="max-w-md mx-auto mt-10 text-blue-500 text-sm font-bold border-t border-white pt-4 w-full text-center">
