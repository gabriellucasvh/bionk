...
export default function DefaultTemplate({ user }: TemplateComponentProps) {
  return (
    <div className="min-h-screen bg-neutral-900 text-neutral-100 py-10 px-4 font-sans flex flex-col">
      ...
      <footer className="max-w-md mx-auto mt-10 text-neutral-400 text-sm font-bold border-t border-white pt-4 w-full text-center">
