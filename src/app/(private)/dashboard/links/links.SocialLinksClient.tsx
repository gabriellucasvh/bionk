...
const SocialLinksClient = () => {
	...
	useEffect(() => {
		if (swrData?.socialLinks) {
			const sorted = [...swrData.socialLinks].sort(
				...
				<CardContent className="space-y-6">
									...
									return (
										...
										>
											<Image
												...
												width={24}
												height={24}
												className="mb-1 sm:mb-1.5 w-6 h-6 sm:w-7 sm:h-7"
											/>
										</Button>
									);
								})}
					...
					{selectedPlatform && (
						<div className="p-3 border rounded-lg space-y-3 bg-muted/20">
							...
							<div>
								<Label htmlFor="usernameInput" className="text-xs sm:text-sm">
