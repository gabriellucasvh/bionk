		...
		<div>
			<div className="grid grid-cols-3 gap-4">
				...
				>
					...
					>
						<Plus weight="regular" className="-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 h-6 w-6 text-black" />
					</div>
				...
				>
					<div
						...
						style={{ aspectRatio: "7 / 7" }}
					>
						<Stack weight="regular" className="-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 h-6 w-6 text-sky-100" />
					</div>
				...
				>
					<div
						...
						style={{ aspectRatio: "7 / 7" }}
					>
						<TextT weight="regular" className="-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 h-6 w-6 text-sky-100" />
					</div>
