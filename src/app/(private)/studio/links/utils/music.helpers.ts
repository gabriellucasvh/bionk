...
export const MUSIC_URL_ERROR_MESSAGE =
  "URL de música inválida. Aceitos: Spotify e Deezer (inclui link curto do Deezer)";
...
const DEEZER_REGEX = /deezer\.com\/(?:[a-z]{2}(?:-[a-z]{2})?\/)?(track|album|playlist)\/[0-9]+/;
...
export function isValidMusicUrl(url: string): {
  ...
  return spotify || deezer || deezerShort
    ? { valid: true }
