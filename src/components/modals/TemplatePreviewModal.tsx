		...
		<Dialog onOpenChange={onOpenChange} open={isOpen}>
			...
			<DialogContent className="w-full max-w-[90vw] rounded-3xl border bg-background p-6 shadow-xl sm:max-w-lg">
				...
				<DialogFooter className="pt-2">
					<Link
						className="inline-flex h-12 w-full items-center justify-center rounded-xl bg-sky-400 px-4 py-2 text-center font-medium text-black transition-colors duration-300 hover:bg-sky-500"
