...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden mt-20 text-white">
      ...
      <div className="container relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-4 py-20 sm:px-6 lg:px-8">
        ...
        {/* Texto principal */}
        <h1 
          className={`mb-6 text-center font-display text-4xl font-bold tracking-tight text-gray-900 transition-all duration-700 sm:text-5xl md:text-6xl lg:text-7xl ${
            isLoaded ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
          }`}
