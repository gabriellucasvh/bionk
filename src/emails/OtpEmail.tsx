...
const baseUrl = process.env.NEXTAUTH_URL
	...
	: "https://bionk.me";
// const logoUrl = `https://res.cloudinary.com/dlfpjuk2r/image/upload/v1755641260/bionk-logo_sehkbi.svg`;
	...
	<Html lang="pt-BR">
		...
		<Body style={main}>
          ...
          <Img src={logoUrl} width="120" height="40" alt="Bionk Logo" />
				...
				<Text style={paragraph}>
					Este código de verificação é válido por {expiryMinutes} minutos. Se
					você não solicitou este código, pode ignorar este e-mail com
					segurança.
				</Text>
				<Hr style={hr} />
