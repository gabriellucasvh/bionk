			...
			<Section style={main}>
				<Container style={container}>
					...
					<Text style={paragraph}>
						Recebemos uma solicitação para alterar o endereço de e-mail
						associado à sua conta Bionk. Para confirmar esta alteração e começar
						a usar seu novo e-mail, por favor, clique no botão abaixo:
					</Text>
					...
					<Text style={paragraph}>
						...
						segurança. O link de confirmação é válido por 1 hora.
					</Text>
					<Text style={paragraph}>
						Atenciosamente,
						<br />A Equipe Bionk
